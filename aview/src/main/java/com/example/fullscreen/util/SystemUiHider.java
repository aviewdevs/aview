...
public abstract class SystemUiHider {
	 ...
	 */
	public static SystemUiHider getInstance(Activity activity, View anchorView, boolean autoHide, int autoHideDelay,
			int flags) {
	...
	/**
	 * Disables the system UI hider. Should be called from {@link Activity#onCreate}.
	 */
